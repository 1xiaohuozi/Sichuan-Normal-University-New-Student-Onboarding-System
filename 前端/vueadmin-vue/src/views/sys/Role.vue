<template>
  <div>
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-button @click="getRoleList" class="el-icon-search">搜索</el-button>
      </el-form-item>

      <el-form-item>
        <el-button type="primary" @click="dialogVisible = true" class="el-icon-plus"
          >新增</el-button
        >
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$axios
            .post("/sys/role/" + (this.editForm.id ? "update" : "save"), this.editForm)
            .then((res) => {
              this.$message({
                showClose: true,
                message: "操作成功",
